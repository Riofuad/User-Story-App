...
import com.example.userstoryapp.getOrAwaitValue
...
class StoryPagerViewModelTest {
    ...
    private lateinit var viewModel: StoryPagerViewModel
    @Mock
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        viewModel = StoryPagerViewModel(storyRepository)
        val actualStory: PagingData<Story> = viewModel.story.getOrAwaitValue()
